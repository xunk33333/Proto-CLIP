...
def run_proto_clip(cfg, visual_memory_keys, visual_memory_values, val_features, val_labels, test_features, test_labels, textual_memory_bank, clip_model, text_prompts):
    ...
    if not cfg['only_test']:
        ...
        for epoch in tqdm(range(cfg['train_epoch'])):
            ...
            with torch.no_grad():
                ...
                model_dir = f"{model_dir_root}/alpha-beta/{best_alpha}-{best_beta}"
